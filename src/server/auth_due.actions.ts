...
export async function signIn(values: z.infer<typeof signInSchema>) {
    ...
    try {
        ...
        const passwordMatch = await argon2.verify(user.hashedPassword, values.password);
        ...
        cookieHandler.set(sessionCookie.name, sessionCookie.value, sessionCookie.attributes);
