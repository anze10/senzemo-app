        ...
        try {
            ...
            const response = await fetch('/api/send-inventory-report', {
                ...
                body: JSON.stringify({
                    ...
                    reportUrl: settings.includeReportUrl ? `${window.location.origin}/inventory` : undefined,
        ...
        <Box sx={{ maxWidth: 1200, margin: 'auto' }}>
            <Box sx={{
                ...
                <Box sx={{
                    ...
                    <Button
                        variant="contained"
                        color="primary"
                        startIcon={reportGenerating ? <CircularProgress size={20} color="inherit" /> : <PictureAsPdfIcon />}
                        ...
                        sx={{ minHeight: 44 }}
                    >
                        {reportGenerating ? "Generating..." : isMobile ? "Generate PDF" : "Generate Report"}
                    </Button>

                    <Button
                        variant="outlined"
                        color="primary"
                        startIcon={reportPreviewLoading ? <CircularProgress size={20} color="inherit" /> : <PreviewIcon />}
                    ...
                    <Button
                        variant="text"
                        color="primary"
                        startIcon={summaryLoading ? <CircularProgress size={20} color="inherit" /> : <SummarizeIcon />}
            ...
            <Card>
                ...
                <CardContent>
                        ...
                        <Box>
                            ...
                            <Box mb={3}>
                                <FormControlLabel
                                    ...
                                    label={
                                        <Box>
                                            <Typography variant="body1">Enable Monthly Reports</Typography>
                                ...
                                <>
                                        ...
                                        <Box display="flex" gap={2} alignItems="center" flexWrap="wrap">
                                            <FormControl size="small" sx={{ minWidth: 200 }}>
                                                ...
                                                <Select
                                                    ...
                                                    onChange={(e) => setSettings(prev => ({ ...prev, dayOfMonth: e.target.value as number }))}
                                                    label="Day of Month"
                                                >
                                                    {Array.from({ length: 28 }, (_, i) => (
                                                        <MenuItem key={i + 1} value={i + 1}>
                                                            {i + 1}{i === 0 ? 'st' : i === 1 ? 'nd' : i === 2 ? 'rd' : 'th'} day
                                                        </MenuItem>
                                                    ))}
                                                </Select>
                                            </FormControl>
                                            ...
                                            <Typography variant="body2" color="textSecondary">
                                                ...
                                                {settings.dayOfMonth === 1 ? 'st' : settings.dayOfMonth === 2 ? 'nd' : settings.dayOfMonth === 3 ? 'rd' : 'th'} of each month
                                            </Typography>
                                        </Box>
                                    </Box>
                                                ...
                                                <FormControlLabel
                                                    control={
                                                        <Switch
                                                            ...
                                                            onChange={(e) => setSettings(prev => ({ ...prev, includeReportUrl: e.target.checked }))}
                                                            size="small"
                                                        />
                                                    }
                                    ...
                                    <Box mb={3}>
                                        ...
                                        {settings.recipients.length === 0 ? (
                                            <Alert severity="info">
                                                No recipients configured. Add at least one recipient to enable email reports.
                                            </Alert>
                                        ) : (
                                            <List>
                                                        ...
                                                        <ListItemText
                                                            ...
                                                            secondary={
                                                                <Box>
                                                                    ...
                                                                    {recipient.role && (
                                                                        <Chip label={recipient.role} size="small" sx={{ mt: 0.5 }} />
                                                                    )}
                                                                </Box>
                                                            }
                                                        />
                    ...
                    <Dialog open={isAddingRecipient} onClose={() => setIsAddingRecipient(false)} maxWidth="sm" fullWidth>
                        ...
                        <DialogActions>
                            <Button onClick={() => setIsAddingRecipient(false)}>Cancel</Button>
                            <Button
