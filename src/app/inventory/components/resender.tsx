  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{ margin: '0', fontSize: '24px' }}>Senzemo Inventory Report</h1>
      ...
      <div style={{
        ...
        <div style={{ margin: '30px 0' }}>
          ...
          <div style={{
            ...
            {sensorInventory.map((sensor, index) => (
              <div key={index} style={{
                padding: '15px 20px',
                borderBottom: index < sensorInventory.length - 1 ? '1px solid #E5E7EB' : 'none',
                display: 'flex',
          ...
          {lowStockItems > 0 && (
            <div style={{
              ...
              <p style={{ color: '#B91C1C', margin: '0', fontSize: '14px' }}>
                {lowStockItems} items are running low on stock. Please review the detailed report and consider restocking.
              </p>
            </div>
          )}
        </div>
        ...
        {/* Report Access */}
        <div style={{ margin: '30px 0' }}>
          <h3 style={{ color: '#1F2937', fontSize: '16px', marginBottom: '15px' }}>
            📊 Detailed Report
          </h3>
          <p style={{ fontSize: '14px', lineHeight: '1.6', color: '#6B7280', marginBottom: '15px' }}>
            For a complete breakdown including frequency analysis, location distribution,
            and detailed inventory tables, please access your dashboard.
          </p>
        ...
        <div style={{
          ...
          <p style={{ fontSize: '14px', color: '#6B7280', lineHeight: '1.6' }}>
            ...
            If you have any questions about this inventory report, please contact your administrator.
          </p>

          <p style={{ fontSize: '12px', color: '#9CA3AF', marginTop: '15px' }}>
            © {new Date().getFullYear()} Senzemo Inventory Management System. All rights reserved.
          </p>
        </div>
      </div>
    </div>
