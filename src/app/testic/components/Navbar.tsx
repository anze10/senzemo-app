...
export function Navbar() {
    ...
    return (
        <Paper elevation={3} className="w-64 bg-gradient-to-b from-blue-600 to-purple-600 text-white p-4">
            <div className="text-2xl font-bold mb-8">Inventory System</div>
            <List>
                {navItems.map((item) => (
                    <ListItem
                        key={item.name}
