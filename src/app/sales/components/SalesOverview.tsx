...
//   const handleRecordOrUpdateSale = (
...
//   useEffect(() => {
//     const newTotalRevenue = sales.reduce(
...
//                           startIcon={
//                             index > 0 &&
//                             index > 0 && sales[index - 1] !== undefined && sales[index - 1] && sales[index].price > sales[index - 1].price ? (
//                               <TrendingUpIcon />
//                             ) : (
//                               <TrendingDownIcon />
//                             )
...
//                           color={
//                             index > 0 &&
//                             sales[index - 1] !== undefined && typeof sales[index - 1]?.price === "number" && sales[index - 1] && typeof sales[index].price === "number" && typeof sales[index - 1].price === "number" && sales[index].price > (sales[index - 1] as Sale).price
//                               ? "success"
//                               : "error"
//                           }
...
//                         >
//                           {index > 0 &&
//                           sales[index - 1] !== undefined &&
//                           typeof sales[index - 1]?.price === "number" &&
//                           typeof sales[index]?.price === "number" &&
//                           sales[index - 1] &&
//                           sales[index] &&
//                           sales[index].price > sales[index - 1].price
//                             ? "Up"
//                             : "Down"}
//                         </Button>
//                       </TableCell>
